...
listen 3002 # we can't use sockets because it breaks no-downtime deploys :(
...
working_directory '/u/apps/photography/current'

# Set the path of the log files
stderr_path '/u/apps/photography/shared/log/unicorn.stderr.log'
stdout_path '/u/apps/photography/shared/log/unicorn.stdout.log'
...
before_exec do |server|
  ...
  ENV["BUNDLE_GEMFILE"] = "/u/apps/photography/current/Gemfile"
end
